...
export class ProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.productsService.getProducts().subscribe((produtos) => {
  ...
  removeProduto(idProduto: number) {
    this.productsService.remove(idProduto).subscribe((res) => {
      alert('Produto removido com sucesso!');
    });
  }

  alteraNomeProduto(idProduto: number) {
    this.productsService.update({ id: idProduto }).subscribe((res) => {
